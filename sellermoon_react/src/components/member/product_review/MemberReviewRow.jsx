...
import { PLUSBTN, RDIVTOP, STARSPAN } from "../../../styles/ReviewStyle";
  ...
  return (
    <>
      ...
      <tbody style={{ borderBottom: "2px solid #b29d82" }}>
        ...
        <td style={{ fontSize: "18px" }} onClick={lReview}>
        ...
        <td>
          {no == review.MEMBER_NO ? (
            <button className="foot-btnbox" onClick={delReview}>
              삭제
            </button>
          ) : null}
          &nbsp;
          {no == review.MEMBER_NO ? (
            <button className="foot-btnbox" onClick={handleShow}>
              수정
            </button>
          ) : null}
        </td>
